...
CREATE TABLE `oms_order` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=armscii8 COMMENT='订单';
...
CREATE TABLE `oms_order_item` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=armscii8 COMMENT='订单项信息';
...
CREATE TABLE `oms_order_operate_history` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=armscii8 COMMENT='订单操作历史记录';
...
CREATE TABLE `oms_order_return_apply` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=armscii8 COMMENT='订单退货申请';
...
CREATE TABLE `oms_order_return_reason` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT 'create_time',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=armscii8 COMMENT='退货原因';
...
CREATE TABLE `oms_order_setting` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=armscii8 COMMENT='订单配置信息';
...
CREATE TABLE `oms_payment_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=armscii8 COMMENT='支付信息表';
...
CREATE TABLE `oms_refund_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=armscii8 COMMENT='退款信息';
