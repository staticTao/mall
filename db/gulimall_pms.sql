...
CREATE TABLE `pms_attr` (
  ...
  PRIMARY KEY (`attr_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=armscii8 COMMENT='商品属性';
...
CREATE TABLE `pms_attr_attrgroup_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=armscii8 COMMENT='属性&属性分组关联';
...
) ENGINE=InnoDB DEFAULT CHARSET=armscii8 COMMENT='属性分组';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=armscii8 COMMENT='品牌';
...
CREATE TABLE `pms_category` (
  ...
  PRIMARY KEY (`cat_id`)
) ENGINE=InnoDB DEFAULT CHARSET=armscii8 COMMENT='商品三级分类';
...
CREATE TABLE `pms_category_brand_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=armscii8 COMMENT='品牌分类关联';
...
CREATE TABLE `pms_comment_replay` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=armscii8 COMMENT='商品评价回复关系';
...
CREATE TABLE `pms_product_attr_value` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=armscii8 COMMENT='spu属性值';
...
CREATE TABLE `pms_sku_images` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=armscii8 COMMENT='sku图片';
...
CREATE TABLE `pms_sku_info` (
  ...
  PRIMARY KEY (`sku_id`)
) ENGINE=InnoDB DEFAULT CHARSET=armscii8 COMMENT='sku信息';
...
CREATE TABLE `pms_sku_sale_attr_value` (
  ...
  `attr_sort` int(11) DEFAULT NULL COMMENT '顺序',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=armscii8 COMMENT='sku销售属性&值';
...
CREATE TABLE `pms_spu_comment` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=armscii8 COMMENT='商品评价';
...
CREATE TABLE `pms_spu_images` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=armscii8 COMMENT='spu图片';
...
CREATE TABLE `pms_spu_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=armscii8 COMMENT='spu信息';
...
CREATE TABLE `pms_spu_info_desc` (
  ...
  PRIMARY KEY (`spu_id`)
) ENGINE=InnoDB DEFAULT CHARSET=armscii8 COMMENT='spu信息介绍';
